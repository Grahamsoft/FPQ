...
ifeq "$(wildcard nbproject/Makefile-local-XC8_18F2585.mk)" "nbproject/Makefile-local-XC8_18F2585.mk"
include nbproject/Makefile-local-XC8_18F2585.mk
endif
endif
...
# Source Files
SOURCEFILES=source/TaskManager.c source/ConfigurationBits.c source/Interrupts.c source/Main.c source/DataCommsTask.c source/TimerTask.c source/SystemSetup.c source/InputTask.c source/OutputTask.c source/Model.c source/OutputSequences.c source/ECAN.c source/ConsoleTask.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-XC8_18F2585.mk dist/${CND_CONF}/${IMAGE_TYPE}/FPQ-1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/source/ConsoleTask.p1: source/ConsoleTask.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/ConsoleTask.p1.d 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit2  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"/Users/David/Projects/FPQ-OnGitHub/Platform Research/MCU_c/FPQ-1.X/source/headers" -I"/Applications/microchip/xc8/v1.12/include/plib" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"  -o${OBJECTDIR}/source/ConsoleTask.p1  source/ConsoleTask.c 
	@-${MV} ${OBJECTDIR}/source/ConsoleTask.d ${OBJECTDIR}/source/ConsoleTask.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/source/ConsoleTask.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/XC8_18F2585
	${RM} -r dist/XC8_18F2585
